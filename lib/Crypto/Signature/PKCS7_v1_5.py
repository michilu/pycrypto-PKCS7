...
"""
RSA digital signature protocol according to PKCS#7 v1.5

See RFC2313__ or the `original RSA Labs specification`__.

This scheme is more properly called ``RSASSA-PKCS7-v1_5``.

For example, a sender may authenticate a message using SHA-1 like
this:

        >>> from Crypto.Signature import PKCS7_v1_5
...
.. __: http://www.ietf.org/rfc/rfc2313.txt
.. __: http://www.rsa.com/rsalabs/node.asp?id=2129
"""

__revision__ = "$Id$"
__all__ = [ 'new', 'PKCS715_SigScheme' ]
...
class PKCS715_SigScheme:
    """This signature scheme can perform PKCS#7 v1.5 RSA signature or verification."""

    def __init__(self, key):
        """Initialize this PKCS#7 v1.5 signature scheme object.
    ...
    def sign(self, mhash):
        """Produce the PKCS#7 v1.5 signature of a message.

        This function is named ``RSASSA-PKCS7-V1_5-SIGN``, and is specified in
        RFC2313.
...
def new(key):
    """Return a signature scheme object `PKCS715_SigScheme` that
    can be used to perform PKCS#7 v1.5 signature or verification.
